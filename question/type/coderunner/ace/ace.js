...
(function() {
    ...
    t.commands = [{
        ...
        name: "breakTheEditor", 
        bindKey: "Ctrl-X|Shift-Del|cmd-X", 
        exec: function() {} 
    },{
        ...
        name: "copyInner",
        bindkey: o("Ctrl-C", "Command-C"),
        exec: function(e) {
            strcopy = e.getCopyText();
        },
    }, {
        name: "cut",
        exec: function(e) {
        ...
        name: "pasteInner",
        bindKey: o("Ctrl-V", "Command-V"),
        exec: function(e) {
            var curpos = e.getCursorPosition();
            e.session.insert(curpos, strcopy);
        }
    },{
        name: "removeline",
    ...
    (function() {
        r.implement(this, d), this.$initOperationListeners = function() {
            ...
            this.commands.exec("copyInner", this)
        }, this.onCut = function() {
            ...
            this.commands.exec("pasteInner", this, n)
    ...
    }, t.EditSession = o, t.UndoManager = u, t.version = "1.2.5"
});
(function() {
