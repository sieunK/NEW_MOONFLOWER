define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function(e, t, n) {
    ...
    function x(e) {
        e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", {
            mode: "normal"
        }), e.on("cursorActivity", Jn), tt(e), v.on(e.getInputField(), "paste", M(e))
    }
    ...
    function K(e, t, n, r, i) {
        ...
        if (r)
            for (var s = 0; s < r.length; s++) J[r[s]] = J[e];
        t && Q(e, t)
    }
            ...
            i = function() {
                ...
                if (i) {
                    ...
                    r = {
                        line: r.line + d,
                        ch: d ? r.ch : v + r.ch
                    }, n.visualLine && (t = E(t.line, 0), r = E(r.line, Pt(e, r.line))), e.setSelection(t, r)
                }
                return [t, r]
            };
    ...
    function Xt(e, t, n, r) {
        ...
        if (n == "char") {
            ...
            return i = St(t.head, 0, o), s = St(t.anchor, 0, u), {
                ranges: [{
                    anchor: s,
                    head: i
                }],
    ...
    function $t(e, t) {
        var n = e.state.vim;
        t !== !1 && e.setCursor(wt(e, n.sel.head)), Ut(e, n), n.visualMode = !1, n.visualLine = !1, n.visualBlock = !1, v.signal(e, "vim-mode-change", {
            mode: "normal"
    ...
    function Qn(e, t) {
        var n = e.getCursor("anchor"),
            r = e.getCursor("head");
        t.visualMode && !e.somethingSelected() ? $t(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && (t.visualMode = !0, t.visualLine = !1, v.signal(e, "vim-mode-change", {
            mode: "visual"
        }));
        if (t.visualMode) {
            var i = Ot(r, n) ? 0 : -1,
                s = Ot(r, n) ? -1 : 0;
            r = St(r, 0, i), n = St(n, 0, s), t.sel = {
                anchor: n,
                head: r
            }, an(e, t, "<", Mt(r, n)), an(e, t, ">", _t(r, n))
    ...
    v.Pos = function(e, t) {
        ...
        }, v.defineOption = function(e, t, n) {}, v.commands = {
            redo: function(e) {
                e.ace.redo()
            },
            undo: function(e) {
        ...
        function() {
            ...
            this.setOption = function(e, n) {
                ...
                else var s = this.ace.session.$findOpeningBracket(i.slice(-2, -1), {
                    row: e.line,
                    column: e.ch + 1
                }, /paren|text/);
                return s && {
    ...
    y.prototype = {
        ...
        function() {
            ...
            v.defineExtension("openDialog", function(n, r, i) {
                ...
                }), i.closeOnBlur !== !1 && v.on(f, "blur", a), f.focus();
                else if (l = s.getElementsByTagName("button")[0]) v.on(l, "click", function() {
                    a(), u.focus()
                ...
                var i = e(this, n, r && r.bottom),
                    s = !1,
                    o, u = r && typeof r.duration != "undefined" ? r.duration : 5e3;
    ...
    var nt, it, st = {
        ...
        findKey: function(e, t, n) {
            ...
            function u() {
                ...
                if (o.type == "partial") return it && window.clearTimeout(it), it = window.setTimeout(function() {
                    r.insertMode && r.inputState.keyBuffer && ut(e)
                }, G("insertModeEscKeysTimeout")), !i;
                it && window.clearTimeout(it);
                if (i) {
                    var a = e.getCursor();
                    e.replaceRange("", St(a, 0, -(n.length - 1)), a, "+input")
                }
    ...
    var ht = {
            matchCommand: function(e, t, n, r) {
                ...
                return s.keys.slice(-11) == "<character>" && (n.selectedCharacter = Ct(e)), {
                    type: "full",
                    command: s
                }
            },
            ...
            processEx: function(e, t, n) {
                ...
                n.type == "keyToEx" ? Fn.processCommand(e, n.exArgs.input) : t.visualMode ? kn(e, {
                    onClose: r,
                    prefix: ":",
                    value: "'<,'>",
                    onKeyDown: i
            ...
            evalInput: function(e, t) {
                ...
                if (s) {
                    if (o.lastSel) {
                        ...
                        b.visualLine ? p = E(h.line + w, h.ch) : b.visualBlock ? p = E(h.line + w, h.ch + S) : b.head.line == b.anchor.line ? p = E(h.line, h.ch + S) : p = E(h.line + w, h.ch), t.visualMode = !0, t.visualLine = b.visualLine, t.visualBlock = b.visualBlock, a = t.sel = {
                            anchor: d,
                            head: p
                        }, Wt(e)
                    ...
                    var x, T, N, C, k;
                    if (t.visualMode) {
                        x = Mt(a.head, a.anchor), T = _t(a.head, a.anchor), N = t.visualLine || o.linewise, C = t.visualBlock ? "block" : N ? "line" : "char", k = Xt(e, {
                            anchor: x,
                            head: T
                        }, C);
                        if (N) {
                            var L = k.ranges;
                            if (C == "block")
                                for (var A = 0; A < L.length; A++) L[A].head.ch = Pt(e, L[A].head.line);
        ...
        pt = {
            ...
            moveByDisplayLines: function(e, t, n, r) {
                ...
                if (o.hitSide)
                    if (n.forward) var u = e.charCoords(o, "div"),
                        a = {
                            top: u.top + 8,
                            left: r.lastHSPos
                        },
        ...
        mt = {
            change: function(e, t, n) {
                ...
                nt.registerController.pushText(t.registerName, "change", i, t.linewise, n.length > 1), yt.enterInsertMode(e, {
                    head: r
                }, e.state.vim)
            },
        ...
        yt = {
            ...
            enterInsertMode: function(e, t, n) {
                ...
                e.setOption("keyMap", "vim-insert"), e.setOption("disableInput", !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {
                    mode: "replace"
                })) : (e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {
                    mode: "insert"
                })), nt.macroModeState.isPlaying || (e.on("change", $n), v.on(e.getInputField(), "keydown", Yn)), n.visualMode && $t(e), It(e, s, o)
            },
            toggleVisualMode: function(e, t, n) {
                ...
                }), Wt(e)) : $t(e) : (n.visualMode = !0, n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise, s = wt(e, E(i.line, i.ch + r - 1), !0), n.sel = {
                    anchor: i,
                    head: s
                }, v.signal(e, "vim-mode-change", {
                    mode: "visual",
                    subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
                }), Wt(e), an(e, n, "<", Mt(i, s)), an(e, n, ">", _t(i, s)))
            },
            reselectLastSelection: function(e, t, n) {
                ...
                if (r) {
                    ...
                    n.sel = {
                        anchor: i,
                        head: s
                    }, n.visualMode = !0, n.visualLine = r.visualLine, n.visualBlock = r.visualBlock, Wt(e), an(e, n, "<", Mt(i, s)), an(e, n, ">", _t(i, s)), v.signal(e, "vim-mode-change", {
                        mode: "visual",
                        subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
                    })
                }
    ...
    var jn = {
            ...
            sort: function(e, t) {
                ...
                var l = E(a, 0),
                    ...
                    g = [];
                if (s)
                    for (var y = 0; y < h.length; y++) p.exec(h[y]) ? m.push(h[y]) : g.push(h[y]);
                else g = h;
    ...
    v.keyMap.vim = {
        ...
        detach: N,
        call: k
    }, K("insertModeEscKeysTimeout", 200, "number"), v.keyMap["vim-insert"] = {
        "Ctrl-N": "autocomplete",
        "Ctrl-P": "autocomplete",
        Enter: function(e) {
    ...
    t.handler = {
        ...
        attach: function(e) {
            e.state || (e.state = {});
            var t = new v(e);
            e.state.cm = t, e.$vimModeHandler = this, v.keyMap.vim.attach(t), or(t).status = null, t.on("vim-command-done", function() {
            ...
            }), t.ace.renderer.setStyle("normal-mode", !or(t).insertMode), e.renderer.$cursorLayer.drawCursor = this.drawCursor.bind(t), this.updateMacCompositionHandlers(e, !0)
        },
        detach: function(e) {
            var t = e.state.cm;
    ...
    }, t.handler.defaultKeymap = b, t.handler.actions = yt, t.Vim = S, S.map("Y", "yy", "normal")
})